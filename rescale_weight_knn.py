...
def IndividualkNN(dataset, kernel_method='rbf', feature='resnet50', nb_teachers=150, num_query=1000, nb_labels=10, ind_budget=20, min_weight=0.1, noisy_scale=0.1, sigma_1=0.1, seed=0, var=1., norm='centering+L2', dataset_path=None, opt_public=True):
