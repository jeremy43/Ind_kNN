...
def IndividualkNN(dataset, kernel_method='rbf', hash_method='knn', seed=0, min_weight=0.2, num_tables=2, proj_dim=12, feature='resnet50',
                  num_query=1000, nb_labels=10, ind_budget=20, noisy_scale=0.1, var=1., norm='centering+L2', dataset_path=None):
